                          ...
                          <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            <div class="-m-2">
                              ...
                              <div class="flex justify-center gap-8 p-2 mt-4 w-full">
                                <button onclick="location.href='{{ route('admin.owners.index') }}'" class="flex text-white bg-gray-300 border-0 py-2 px-6 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
                                <button class="flex text-white bg-blue-500 border-0 py-2 px-12 focus:outline-none hover:bg-blue-600 rounded text-lg">登録</button>
                              </div>
                            </div>
                          </div>
                        </div>
